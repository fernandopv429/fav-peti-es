...
import { LayoutDashboard, FilePlus, FileText, FolderOpen, Scale, X, LogOut, BookMarked, ChevronRight, Calculator, Shield, TrendingUp } from "lucide-react";
...
const navItems = [
  ...
  { label: "Defesa", icon: Shield, path: "/defesa" },
